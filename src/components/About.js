...
const About = () => {
  ...
  return (
    <Container maxWidth="md">
      <Paper
        style={{padding: 5, border: `1px solid ${theme.palette.primary.main}`, "marginTop": 10}}
      >
        ...
        <Typography
          ...
          color="primary"
        >
          If any of these apply to you, your actual risk profile may be significantly different to what is shown. Also, if you are taking MHT through a 
          patch, gel or vaginally, these results might not be relevant as much of the data is based on MHT pills.
        </Typography>
        <br/>
        ...
        <Grid container justifyContent="space-evenly">
          <Grid item xs={4}>
            <Button
              href="/questionnaire"
              style={{background: theme.palette.primary.main, padding: 5, border: `1px solid ${theme.palette.primary.main}`, marginTop: 10, textTransform: "none", height: "90%"}}
              fullWidth
            >
